...
def main(args):
    ...
    datasubset_val = torch.utils.data.Subset(dataset_test, length[split_at:])

    if args.distributed:
        sampler_train = DistributedSampler(datasubset_train)
        sampler_val = DistributedSampler(datasubset_val, shuffle=False)
    else:
        sampler_train = torch.utils.data.RandomSampler(datasubset_train)
        sampler_val = torch.utils.data.SequentialSampler(datasubset_val)
    ...
    if args.dataset_file == "coco_panoptic":
        ...
        base_ds = get_coco_api_from_dataset(datasubset_val)
